...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format"
    ...
    <xsl:param name="outsideAirportSafetyZone" select="$tmx/tu[@tuid='outsideAirportSafetyZone']/tuv[lang($lang)]/seg"/>
        ...
        <fo:root>
            ...
            <fo:page-sequence master-reference="A4-portrail" font-family="Roboto Regular">
                ...
                <fo:flow flow-name="xsl-region-body" border-collapse="collapse" reference-orientation="0">
                    ...
                    <fo:block width="100%" padding-top="2.5mm" font-size="10pt">
                        <xsl:value-of select="$outsideAirportSafetyZone"/>
                    </fo:block>
                </fo:flow>
            </fo:page-sequence>
        </fo:root>
